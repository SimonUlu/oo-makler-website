---
id: 70f12d35-83f5-44f7-a93b-f84a0959fabc
blueprint: leistungen
template: pages/leistungen/cta-page
view_model: App\ViewModels\VerkaufenViewModel
title: 'Gestalten Sie Ihre Vermieten-Seite! (Dupliziert) (3)'
subtitle: 'Verstärken Sie die Aussage Ihres Titels mit einer kleinen Beschreibung die den Inhalt der Seite zusammenfässt.'
description: 'Service 1'
subheaderheadline: 'Auch auf den Unterseiten ist alles anpassbar !'
subheaderdescription: 'Zeigen Sie, warum Sie professioneller Partner sind, wenn es um die Vermietung von Immobilien geht, indem Sie Ihre Services darstellen:'
content_image_1:
...
steps:
  -
    ...
    number: '1'
    header: 'Lorem Ipsum'
    description: 'Beschreiben Sie Ihren Service, in 3-4 Zeilen und bringen Sie Ihren Kunden so Ihre Professionalität nahe. Welchen'
...
updated_at: 1715602291
headerbild:
  - architecture-gef0672c68_1920.jpg
stepsheader: 'Hier ist Platz für ihren Vorgehensplan für die Vermietung'
stepssubheader: 'Zeigen Sie Ihre Expertise, in dem Sie Ihrem Kunden zeigen, wie strukturiert Sie für ihn arbeiten würden'
image_second:
  - architecture-gef0672c68_1920.jpg
...
services:
  -
    ...
    itemheader: 'Service 1'
    itemdescription: 'Hier wird beschrieben, um was es sich bei "Service 1" handelt.'
    type: new_set
    enabled: true
  -
    id: lnlo9d4y
    ...
    itemheader: 'Service 2'
    itemdescription: 'Hier wird beschrieben, um was es sich bei "Service 2" handelt.'
    type: new_set
    enabled: true
  -
    id: lnlo9bys
    ...
    itemheader: 'Service 3'
    itemdescription: 'Hier wird beschrieben, um was es sich bei "Service 3" handelt.'
    type: new_set
    enabled: true
  -
    id: lnlo9aqg
    ...
    itemheader: 'Service 4'
    itemdescription: 'Hier wird beschrieben, um was es sich bei "Service 4" handelt.'
    type: new_set
    enabled: true
...
content_with_image_replicator:
  -
    id: lolmfqdf
    headline: 'Beschreibung der Unterseite in Wort'
    text:
      -
        type: paragraph
        attrs:
        ...
        content:
          -
            type: text
            text: 'Sie wollen keine Videobeschreibung auf Ihrer Seite oder denken, dass Sie zusätzlich noch eine Beschreibung Ihrer Seite im Fließtext brauchen? Kein Problem, nutzen Sie diese Sektion, um Ihrer Kreativität den Raum zu schenken, den sie verdient hat.'
    image_section_list:
      -
        id: lolmhnby
