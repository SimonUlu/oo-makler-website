@if(count($estate['estate_images']) > 3)
    <div class="relative w-full h-full -mt-[60px]">
        ...
        <div class="px-2 pt-10 mx-auto sm:px-4 sm:pt-0 lg:grid lg:grid-cols-3 lg:gap-x-4 mt-[40px] md:mt-[80px]">
            <div class="hidden overflow-hidden rounded-lg md:block aspect-w-3 aspect-h-2 lg:col-span-2 lg:row-span-2">
...
@if(!empty($estate['estate_images']))
    <x-estates.image-slideshow :estateImgs="$estate['estate_images']" />
@endif
