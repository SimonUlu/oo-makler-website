    ...
    <div class="grid w-full max-w-lg grid-cols-1 md:flex-col md:mb-0 md:space-x-0 md:max-w-none">
        ...
        <div class="relative w-full ">
                ...
                <div class="relative w-auto overflow-hidden h-80 min-w-64">
                    <div>
                        <img data-src="https://upload.wikimedia.org/wikipedia/commons/3/3f/Placeholder_view_vector.svg" class="absolute inset-0 object-cover w-full h-full rounded-t-lg object-fit-cover lazy"
                        loading="lazy" />
                        <div class="absolute transform -translate-x-1/2 -translate-y-1/2 spinner top-1/2 left-1/2">
                        <svg class="w-5 h-5 animate-spin" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            ...
            <div class="relative px-5 pt-2 pb-2 border rounded-b-lg md:pt-0">
                <div class="space-y-2 text-md mb-2.5 text-lg font-bold text-gray-900 md:mt-4 ">
                    ...
                    <div class="grid grid-cols-4">
                        ...
                        <span class="hidden lg:block capitalize inline-flex items-center rounded-full bg-primary-900 px-2.5 py-0.5 text-sm font-medium text-white">
                                        verkauft
                                    </span>
                        {{/if}}
                        {{if elements.vermarktungsart == 'miete'}}
                        <span class="hidden lg:block capitalize inline-flex items-center rounded-full border border-primary text-primary px-2.5 py-0.5 text-sm font-medium">
                                        vermietet
                                    </span>
                        {{/if}}
                        {{/if}}
