<!-- Activity list -->
<div class="border-t border-white/10 max-w-7xl mx-auto py-16">
    <h2 class="px-4 text-2xl lg:text-4xl font-semibold leading-7 text-white sm:px-6 lg:px-8 mb-12">
    ...
    <table class="mt-6 w-full whitespace-nowrap text-left">
      ...
      <thead class="border-b border-white/10 text-sm leading-6 text-white">
        <tr>
          <th scope="col" class="py-2 pl-4 pr-8 font-semibold sm:pl-6 lg:pl-8">Einheit</th>
          <th scope="col" class="hidden py-2 pl-0 pr-8 font-semibold sm:table-cell">Immobilienart</th>
          <th scope="col" class="py-2 pl-0 pr-4 text-right font-semibold sm:pr-8 sm:text-left lg:pr-20">Etage</th>
          <th scope="col" class="hidden py-2 pl-0 pr-8 font-semibold md:table-cell lg:pr-20">Zimmer</th>
          <th scope="col" class="hidden py-2 pl-0 pr-4 text-right font-semibold sm:table-cell sm:pr-6 lg:pr-8">Fläche</th>
          <th scope="col" class="hidden py-2 pl-0 pr-4 text-right font-semibold sm:table-cell sm:pr-6 lg:pr-8">Kaufpreis</th>
        </tr>
      </thead>
