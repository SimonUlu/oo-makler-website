<div class="h-[100px] border-t border-l border-r border-b border-gray-200 md:py-4 inline-flex gap-x-4 pl-4 rounded-l-lg">
...
<div class="h-[100px] border-t border-r border-b border-gray-200 md:py-4 inline-flex gap-x-4 pl-4">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div>
    <p class="font-medium"> Objektart </p>
    <p class="text-sm capitalize"> {{$estate["elements"]["objekttyp"]}} </p>
    </div>
</div>
<div class="h-[100px] border-t border-r border-b border-gray-200 md:py-4 inline-flex gap-x-4 pl-4">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <p class="text-sm"> {{$estate["elements"]["wohnflaeche"]}} </p>
    </div>
    </div>
<div class="h-[100px] border-t border-r border-b border-gray-200 md:py-4 inline-flex gap-x-4 pl-4 rounded-r-lg">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <p class="font-medium"> Vermarktungsart </p>
